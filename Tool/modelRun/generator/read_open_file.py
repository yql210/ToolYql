...
def main():
    data_open_file = './data_open/Belle_open_source_0.5M.jsonl'

    data_open_save_file = './data_open/Belle_open_source_主题.jsonl'

    file_save_path = data_open_save_file
