...
def main():
    ...
    file_train_save_path = './SArag_all/SArag_train_train_data_0_' + str(int(percentage * 10)) + '.jsonl'
    ...
    out_index = int(len(input_datas) * percentage)




    for data in input_datas[:out_index]:
